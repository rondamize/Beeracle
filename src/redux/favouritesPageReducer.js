...
let initialState = {
    favourites: [
        {id:1, name: 'C Is For Cookie', rating: '4.5', abv: '8.5% ABV', isFavourite: true, picture: cIsForCookie},
        {id:2, name: 'Sabotage', rating: '4.4', abv: '6.5% ABV', isFavourite: true, picture: sabotage},
        {id:3, name: 'Solid bite', rating: '4.3', abv: '4% ABV', isFavourite: true, picture: solidBite},
        {id:4, name: 'Solid bite', rating: '4.3', abv: '4% ABV', isFavourite: true, picture: solidBite},
        {id:5, name: 'Sabotage', rating: '4.4', abv: '6.5% ABV', isFavourite: true, picture: sabotage},
        {id:6, name: 'Solid bite', rating: '4.3', abv: '4% ABV', isFavourite: true, picture: solidBite},
    ],
